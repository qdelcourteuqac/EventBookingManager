...
public class JwtTokenServiceImpl implements JwtTokenService {
    ...
    private Jws<Claims> validateJwtRefreshToken(String token) {
        ...
        Account user = (Account) userService.loadUserByUsername(claims.getBody().getSubject());

        return parser.require(USER_SECRET, user.getPassword()).parseClaimsJws(token);
    }
    ...
    private Claims buildUserClaims(Account user) {
